...
<head>
    ...
    <title>Home - Nerdvana</title>
    <!-- Css -->
    {{--    <link rel="stylesheet" href="style.css" />--}}
    {{--    because css does not work if we have more than one forward slashes in the route given so we use asset--}}
...
<div id="wrapper">
   ...
   @yield('header')
    ...
    <div class="sidebar">
        ...
        <p class="brand-title"><a href="">Nerdvana Blog</a></p>
